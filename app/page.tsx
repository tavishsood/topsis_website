...
export default function App() {
	...
	const runTOPSIS = async () => {
		...
		try {
			...
			// Email Logic
			if (email) {
				// Generate a simple HTML table for the top 5 results
				const topResults = finalData
					...
					<tr style="border-bottom: 1px solid #eee;">
						...
						<td style="padding: 8px;">${row[Object.keys(row)[0]]}</td>
						<td style="padding: 8px; font-weight: bold;">${row.Score}</td>
					</tr>
				`,
					)
					.join("");
				...
				const emailHtml = `
					<div style="font-family: serif; max-width: 600px; margin: auto; color: #333;">
						<h2 style="border-bottom: 2px solid #000; padding-bottom: 10px;">TOPSIS Analysis Report</h2>
						<p>Your dataset has been successfully analyzed. Here are the top 5 alternatives:</p>
						...
						<p style="margin-top: 30px; font-size: 12px; color: #888;">Generated by TOPSIS Calculator</p>
					</div>
				`;
			...
			<main className="max-w-4xl mx-auto px-6 py-16">
				...
				>
					<div className="space-y-12">
						...
						{/* Step 2: Parameters */}
						{/* Changed to lg:grid-cols-3 to accommodate email */}
